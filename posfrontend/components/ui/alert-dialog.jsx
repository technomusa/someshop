...
function AlertDialogContent({
  ...
  return <AlertDialogPortal>
    ...
    className={cn(
      "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-1/2 left-1/2 z-50 grid w-full max-w-[min(560px,calc(100%-1.5rem))] translate-x-[-50%] translate-y-[-50%] gap-5 rounded-xl border p-5 shadow-2xl duration-200 sm:p-6 max-h-[85vh] overflow-auto",
      className
    )}
    {...props}
  />
